...
https://eo4society.esa.int/event/esas-2026-earthcare-maap-hackathon/
...
To minimize technical issues and spend as much time as possible actually working on data, please check out our getting started resources and read through the [how2hack](https://github.com/smbrose/earthcare-maap-hackathon/blob/main/how2hack.md) documentation carefully. <br />
During the Hackathon, you can either build a science team, join an existing one, explore in loose collaborations with others or work on your own. <br />
The hackathon will make use of ESA’s MAAP (Multi-mission Algorithm and Analysis Platform), a collaborative JupyterLab environment. To ensure your account is ready for the online practical sessions and the hackathon please complete these steps as soon as possible:
...
Important: When joining, please specify that you are participating in the EarthCARE MAAP Hackathon to expedite approval.
...
**Monday, April 20**  - Please arrive at ESRIN between **13:30 - 13:45**.
...
| 17:00 - 19:00 | _Aperitivo_ | |
| 19:00 | Shuttle bus to Frascati | |
...
The train with final destination “Frascati” arrives directly in the Frascati city centre and is the most practical connection if you go to a hotel in the centre of Frascati. One-way ticket price is around 2€ and can be purchased at vending machines or online. Travel time is 30'. From Frascati centre it is possible to walk to ESRIN (a pleasant stroll of approximately 3km) or to use the ESRIN Shuttle bus departing from Piazza Marconi. The shuttle has very limited capacity and it advisable to coordinate with the organisers if you intend to make use of it. Travel time is 10-15' by shuttle or 30' on foot.
...
- Ciampino: cheaper options and easy connections from Ciampino train station towards Tor Vergata 
- Frascati: several (mid) options and close to the venue. The Hackathon dinner will be in Frascati. Just make sure to contact the organisers for advice on reaching ESRIN on foot or with the shuttle bus. 
